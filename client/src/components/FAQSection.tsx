...
export default function FAQSection() {
  ...
  const fallbackData: FAQItem[] = useMemo(
    () => [
      {
    ...
    <section id="faq" className="py-20 bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {loading && <p className="text-center text-muted-foreground">Loading answers...</p>}
          {error && !loading && (
            <p className="text-center text-destructive" data-testid="faq-error">
              {error}
            </p>
          )}

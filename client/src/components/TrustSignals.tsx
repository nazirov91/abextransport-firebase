...
const trustSignals = [
  ...
  },
  {
    ...
    description: 'Successfully transported over 2,000 vehicles nationwide',
  },
  {
    icon: Star,
    title: '4.8/5 Rating',
    subtitle: 'From 1,200+ Customer Reviews',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            We're fully licensed, insured, and committed to providing the highest quality auto
            transport services.
          </p>
        </div>
            ...
            return (
              <Card key={index} className='text-center border-card-border'>
                <CardContent className='pt-6'>
                  ...
                  <div className='text-2xl font-bold text-foreground mb-1'>{signal.title}</div>
                  <div className='text-sm font-medium text-primary mb-2'>{signal.subtitle}</div>

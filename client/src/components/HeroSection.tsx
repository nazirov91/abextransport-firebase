          ...
          <div className='space-y-8'>
            ...
            <div className='flex flex-wrap items-center gap-6'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-sm font-medium text-white drop-shadow-2xl'>4.8/5 Rating</span>
              </div>
              <div className='text-sm text-white/80 drop-shadow-2xl'>
                Over 2,000 vehicles transported
              </div>
            </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
              <div className='flex items-center gap-3'>
                ...
                <span className='text-white/90 drop-shadow-2xl'>Fully Insured & Licensed</span>
              </div>
              <div className='flex items-center gap-3'>
                <CheckCircle className='h-5 w-5 text-chart-2 flex-shrink-0' />

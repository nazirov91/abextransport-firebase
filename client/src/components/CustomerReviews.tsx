...
const reviews = [
  {
    ...
    rating: 5,
    review:
      'Outstanding service! They picked up my BMW exactly on time and delivered it in perfect condition. The driver was professional and the price was very competitive. Highly recommend!',
    image: testimonial1,
  ...
  },
  {
    ...
    rating: 5,
    review:
      'I was nervous about shipping my car across the country, but AutoShip Pro made it so easy. Excellent communication throughout, and my vehicle arrived exactly when promised.',
    image: testimonial2,
  ...
  },
  {
    ...
    rating: 5,
    review:
      'Needed to transport my truck for a job relocation. The team was incredibly helpful, the price was fair, and everything went smoothly. Will definitely use again!',
    image: testimonial3,
    shipment: 'Ford F-150',
  },
];
...
const additionalStats = [
  { label: 'Google Reviews', value: '4.8/5', count: '200+' },
  { label: 'Transport Reviews', value: '4.8/5', count: '800+' },
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Don't just take our word for it. Here's what thousands of satisfied customers have to
            say about their auto transport experience with us.
          </p>
        </div>
              ...
              <CardContent className='pt-6'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <div className='text-xs text-primary font-medium'>{review.shipment}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
